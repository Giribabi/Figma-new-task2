...
function Home(){
    ...
    const pageLastIndex = currentPageNumber * usersPerPage;
    const pageFirstIndex = pageLastIndex - usersPerPage;
    const currentUsers = usersList.slice(pageFirstIndex, pageLastIndex)
        ...
        <div className="home-page-container">
            <div className="home-page">
                ...
                </div>
                {
                    ...
                    :
                    <div className="users-data-container" id="users">
                        {
                            loading
                            ?
                            <Loader/>
